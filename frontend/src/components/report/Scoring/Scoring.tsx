...
const Scoring: React.FC<Props> = ({ score }: Props) => {
    ...
    switch (score) {
        case 1:
            return (
                <div className="scoring">
                    <h3 className="title">Your product is not inclusive in terms of Accessibility</h3>
        ...
        case 2:
            return (
                <div className="scoring">
                    <h3 className="title">Your product is limited inclusive in terms of Accessibility</h3>
        ...
        case 3:
            return (
                <div className="scoring">
                    <h3 className="title">Your product is emergent inclusive in terms of Accessibility</h3>
        ...
        case 4:
            return (
                <div className="scoring">
                    <h3 className="title">Your product is structured inclusive in terms of Accessibility</h3>
        ...
        case 5:
            return (
                <div className="scoring">
                    <h3 className="title">Your product is leading the way in terms of Accessibility</h3>
